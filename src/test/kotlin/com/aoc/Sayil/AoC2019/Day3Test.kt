...
import com.aoc.Sayil.AoC2019.solutions.Day3
...
class Day3Test {
    ...
    inner class Part1 {
        ...
        fun `Actual answer`() {
            // Given
            val input = input3.formattedInput

            // When
            val answer = Day3(input).first()

            // Then
            assertThat(answer).isEqualTo(651)
        }
    }
    ...
    inner class Part2 {
        ...
        fun `Actual answer`() {
            ...
            // Then
            assertThat(answer).isEqualTo(7534)
        }
    }
}